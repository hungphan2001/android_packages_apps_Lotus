...
import com.lotus.settings.preferences.SystemSettingSeekBarPreference;
...
public class ClockDateSettings extends SettingsPreferenceFragment implements OnPreferenceChangeListener, Indexable {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.lotus_settings_statusbar_clock_date);
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
                    ...
                    sir.xmlResId = R.xml.lotus_settings_statusbar_clock_date;
                    result.add(sir);
                    return result;
                }
                 @Override
