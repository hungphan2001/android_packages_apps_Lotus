/*
 * Copyright (C) 2019 The lotus Project
 *
...
public class VolumePanel extends SettingsPreferenceFragment implements Indexable {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.lotus_settings_button_volume_panel);
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
                    ...
                    sir.xmlResId = R.xml.lotus_settings_button_volume_panel;
                    result.add(sir);
                    return result;
                }
                 @Override
