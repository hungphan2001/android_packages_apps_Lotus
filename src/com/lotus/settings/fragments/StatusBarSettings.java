...
public class StatusBarSettings extends SettingsPreferenceFragment implements
    ...
    private SwitchPreference mShowLotusLogo;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mShowLotusLogo = (SwitchPreference) findPreference(KEY_STATUS_BAR_LOGO);
        mShowLotusLogo.setChecked((Settings.System.getInt(getContentResolver(),
             Settings.System.STATUS_BAR_LOGO, 0) == 1));
        mShowLotusLogo.setOnPreferenceChangeListener(this);
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
                    ...
                    sir.xmlResId = R.xml.lotus_settings_statusbar;
                    result.add(sir);
                    return result;
                }
                 @Override
